...
struct DayShiftEditorView: View {
    ...
    private var dateText: String {
        guard let date = KoyomiCalendar.date(fromDayKey: dayKey) else { return dayKey }
        return KoyomiCalendar.displayDate(for: date)
    }
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    KoyomiPrimaryButton(title: "保存", isEnabled: selectedTemplateID != nil) {
                        save()
                    }
