...
struct PayrollSummaryView: View {
    ...
    private var timeCard: some View {
        ...
        return ShiftTechoCard {
            VStack(alignment: .leading, spacing: ShiftTechoTheme.Spacing.s) {
                Text("勤務時間")
...
private struct SummaryRow: View {
    ...
    var body: some View {
        HStack {
            Text(title)
                .font(ShiftTechoTheme.bodyFont)
            Spacer(minLength: ShiftTechoTheme.Spacing.s)
            Text(value)
                .font(emphasized ? ShiftTechoTheme.headlineFont : ShiftTechoTheme.bodyFont)
        }
