...
final class ShiftTechoStore {
    ...
    func assign(
        ...
        guard ShiftTechoCalendar.date(fromDayKey: dayKey) != nil else { return nil }
    ...
    func assignRange(
        ...
        for key in keys where ShiftTechoCalendar.date(fromDayKey: key) != nil {
