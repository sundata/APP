...
def _datetime_from_client_timestamp(timestamp: float) -> datetime:
    """Accept App Store timestamps sent as seconds or milliseconds."""
...
class SubscriptionManager:
    ...
    async def verify_receipt(self, receipt_data: ReceiptData) -> dict:
        ...
        try:
            ...
            expiration_date = _datetime_from_client_timestamp(receipt_data.expirationDate)
    ...
    async def notify_purchase(self, purchase_info: PurchaseNotification, user_id: str) -> bool:
        ...
        try:
            ...
            self.subscriptions[user_id] = {
                ...
                "purchaseDate": _datetime_from_client_timestamp(purchase_info.timestamp),
...
_notification_manager: Optional[FirebaseNotificationManager] = None
...
def get_notification_manager(
    ...
    if _notification_manager is None:
        _notification_manager = FirebaseNotificationManager(firebase_creds_path)
