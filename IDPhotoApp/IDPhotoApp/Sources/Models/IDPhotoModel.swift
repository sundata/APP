...
struct IDPhotoSize: Identifiable, Hashable {
    ...
    /// カスタムサイズ情報
    struct CustomSizeInfo: Equatable {
        var widthMM: Double
        var heightMM: Double
        var name: String
        ...
        static let defaultInfo = CustomSizeInfo(widthMM: 35, heightMM: 45, name: "カスタムサイズ")
    }
}
...
extension IDPhotoSize {
    static let allSizes: [IDPhotoSize] = [
        ...
        IDPhotoSize(id: "visa_kr",        name: "韓国ビザ",           widthMM: 35, heightMM: 45, category: .passport,   description: "韓国ビザ用（35×45mm）",             dpi: 300),
        IDPhotoSize(id: "visa_uk",        name: "英国ビザ",           widthMM: 35, heightMM: 45, category: .passport,   description: "イギリスビザ用（35×45mm）",         dpi: 300),
        IDPhotoSize(id: "visa_ca",        name: "カナダビザ",         widthMM: 35, heightMM: 45, category: .passport,   description: "カナダビザ用（35×45mm）",           dpi: 300),
        IDPhotoSize(id: "visa_au",        name: "澳洲ビザ",           widthMM: 35, heightMM: 45, category: .passport,   description: "オーストラリアビザ用（35×45mm）",   dpi: 300),

        // ── <minimax:tool_call>・資格 ──
        IDPhotoSize(id: "exam_standard",  name: "資格試験",           widthMM: 30, heightMM: 40, category: .license,    description: "資格試験申込用（30×40mm）",         dpi: 300),

        // ── マイナンバー ──
        IDPhotoSize(id: "mynumber",       name: "マイナンバー",        widthMM: 35, heightMM: 45, category: .mynumber,   description: "個人番号カード用（35×45mm）",       dpi: 300),
        IDPhotoSize(id: "residence",      name: "在留カード",          widthMM: 30, heightMM: 40, category: .mynumber,   description: "在留カード申請用（30×40mm）",       dpi: 300),

        // ── 就職・履歴書 ──
        IDPhotoSize(id: "resume_l",       name: "履歴書（大）",       widthMM: 40, heightMM: 50, category: .employment, description: "履歴書・大（40×50mm）",             dpi: 300),
        IDPhotoSize(id: "resume_s",       name: "履歴書（小）",       widthMM: 30, heightMM: 40, category: .employment, description: "履歴書・小（30×40mm）",             dpi: 300),
        IDPhotoSize(id: "employment",     name: "就職エントリー",     widthMM: 35, heightMM: 45, category: .employment, description: "企業エントリーシート用（35×45mm）", dpi: 300),
        IDPhotoSize(id: "us_2x3",         name: "2×3インチ",          widthMM: 51, heightMM: 76,  category: .employment, description: "アメリカ履歴書・申請用（51×76mm）",  dpi: 300),
        IDPhotoSize(id: "us_passport",    name: "USパスポート",        widthMM: 51, heightMM: 51,  category: .passport,   description: "アメリカパスポート用（51×51mm）",  dpi: 300),

        // ── 中国・台湾規格 ──
        IDPhotoSize(id: "cn_1寸",        name: "1インチ（中国）",     widthMM: 25, heightMM: 35, category: .other,      description: "中国系写真（25×35mm）",             dpi: 300),
        IDPhotoSize(id: "cn_2寸",        name: "2インチ（中国）",     widthMM: 35, heightMM: 53, category: .other,      description: "中国系大中写真（35×53mm）",         dpi: 300),

        // ── 韓国規格 ──
        IDPhotoSize(id: "kr_3x4",        name: "3×4cm（韓国）",     widthMM: 30, heightMM: 40, category: .other,      description: "韓国標準証明写真（30×40mm）",      dpi: 300),

        // ── ベトナム規格 ──
        IDPhotoSize(id: "vn_3x4",        name: "3×4cm（ベトナム）", widthMM: 30, heightMM: 40, category: .other,      description: "ベトナム証明写真（30×40mm）",      dpi: 300),
        IDPhotoSize(id: "vn_4x6",        name: "4×6cm（ベトナム）", widthMM: 40, heightMM: 60, category: .other,      description: "ベトナム申請用（40×60mm）",        dpi: 300),

        // ── タイ規格 ──
        IDPhotoSize(id: "th_3x4",        name: "3×4cm（タイ）",      widthMM: 30, heightMM: 40, category: .other,      description: "タイ証明写真（30×40mm）",           dpi: 300),

        // ── その他 ──
        IDPhotoSize(id: "student_id",    name: "学生証",             widthMM: 30, heightMM: 40, category: .other,      description: "学生証・社員証用（30×40mm）",      dpi: 300),
        IDPhotoSize(id: "ca_35x45",      name: "35×45mm（汎用）",     widthMM: 35, heightMM: 45, category: .other,      description: "汎用規格（35×45mm）",             dpi: 300),
    ]
...
struct EditState: Equatable {
    ...
    /// カスタムサイズ（選択中の場合のみ有効）
    var customSize: IDPhotoSize.CustomSizeInfo?
    /// カスタムサイズを使用中かどうか
    var usingCustomSize: Bool { customSize != nil }
